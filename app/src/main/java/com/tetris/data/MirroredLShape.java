...
public class MirroredLShape extends Shape {
    ...
    public MirroredLShape(MirroredLShape mirroredLShape)
    {
        super(mirroredLShape.m_x, mirroredLShape.m_y);
    }
    ...
    @Override
    public void down() {
        if (rotated_angle == 0 || rotated_angle == 270) {
            if (m_y != 21)
                ++m_y;
        }
        if(rotated_angle == 90) {
    ...
    {
        MirroredLShape mirroredLShape = new MirroredLShape(this);
        mirroredLShape.rotate();
        return mirroredLShape.shapeCoordinate();
    }
